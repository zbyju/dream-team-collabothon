import { Box, Container, Grid, GridItem, Text, Link, Table, Tr, Button, Th, Heading, Tbody } from "@chakra-ui/react";
...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <Box bg='orange.200' h='11em' maxHeight="11em" w='full' maxW='full' outline='' mb={32}>
